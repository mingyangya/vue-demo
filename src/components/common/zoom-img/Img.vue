<template>
  <div :class="['zoom-img-container', 'zoom-img-dialog', { mobile: isMobile }]" v-if="show">
    <transition name="fade">
      <div modal-mask class="modal-mask" @click="close">
      </div>
    </transition>
    <transition :name="transition">
      <div :class="['modal-main', isMobile ? 'mobile': 'pc']" :style="mainStyle">
        <div class="close">
        ...
        <div class="modal-content">
          <div class="img-box" ref="imgBoxEle" :style="zoomArea">
            <div class="img-wrap" ref="imgWrapEle">
              <img ref="imgEle" :src="img || defaultImg" :style="imgStyle" alt="zoom-img">
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    imgStyle () {
      ...
      return {
        transform: `translate(${x}px, ${y}px) scale(${this.ratio / 100})`
      }
    },
    mainStyle () {
      return {
